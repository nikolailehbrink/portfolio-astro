...
Deno is a modern runtime for JavaScript and TypeScript created by, the original creator of Node.js. At the end of last year, I watched their [Deno 2 Announcement Video](https://www.youtube.com/watch?v=d35SlRgVxT8) and really wanted to try it out. I saw this as the perfect opportunity.
...
One of Deno's standout features is its native TypeScript support. Unlike Node.js, which requires additional setup with tools like  or, Deno runs TypeScript files directly. This allowed us to write our script in TypeScript without any configuration or build steps.
...
We imported the using Deno's npm compatibility:
