...
Resend is a developer-friendly email service that makes it easy to send transactional and marketing emails. To get started, [sign up for a Resend account](https://resend.com/signup) and obtain your API key.
