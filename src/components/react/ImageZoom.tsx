  ...
  return (
    <div
      className={cn(
        ...
        '[&_[data-rmiz-btn-zoom]]:m-0 [&_[data-rmiz-btn-zoom]]:touch-manipulation [&_[data-rmiz-btn-zoom]]:bg-foreground/60 [&_[data-rmiz-btn-zoom]]:backdrop-blur-lg [&_[data-rmiz-btn-zoom]]:rounded-xl [&_[data-rmiz-btn-zoom]]:p-1.5 [&_[data-rmiz-btn-zoom]]:text-background [&_[data-rmiz-btn-zoom]]:absolute [&_[data-rmiz-btn-zoom]]:bottom-0 [&_[data-rmiz-btn-zoom]]:right-0 [&_[data-rmiz-btn-zoom]]:rounded-tr-none [&_[data-rmiz-btn-zoom]]:rounded-bl-none',
